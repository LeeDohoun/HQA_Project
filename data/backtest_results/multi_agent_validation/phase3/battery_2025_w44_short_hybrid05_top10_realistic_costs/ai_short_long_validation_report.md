...
- Theme: 2차전지 (2차전지)
- Generated at: 2026-05-18T14:22:29.101429
- Row count: 2
...
|---|---:|---:|---:|---:|---:|---|
| overall | 1 | 0.00% | -4.54% | -4.54% | 0.00% | pilot |
| horizon:short | 1 | 0.00% | -4.54% | -4.54% | 0.00% | pilot |
| short_hybrid_05 | 1 | 0.00% | -4.54% | -4.54% | 0.00% | pilot |

## Period Results

| Period | Horizon | Strategy | Status | Return | Benchmark | Excess | Delta vs Baseline | MDD | Worst Period | Loss Streak | Hit Rate | Picks |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| validation_2025_w44_top10 | short | deterministic_short | completed | 4.12% | 1.01% | 3.11% | 0.00% | 0.00% | 4.12% | 0 | 66.67% | 천보/레몬/엠플러스 |
| validation_2025_w44_top10 | short | short_hybrid_05 | completed | -0.42% | 1.01% | -1.43% | -4.54% | 0.00% | -0.42% | 1 | 33.33% | 천보/테이팩스/코세스 |
...
- summary_json: `data/backtest_results/multi_agent_validation/phase3/battery_2025_w44_short_hybrid05_top10_realistic_costs/ai_short_long_validation_summary.json`
- summary_csv: `data/backtest_results/multi_agent_validation/phase3/battery_2025_w44_short_hybrid05_top10_realistic_costs/ai_short_long_validation_summary.csv`
- raw_results_json: `data/backtest_results/multi_agent_validation/phase3/battery_2025_w44_short_hybrid05_top10_realistic_costs/ai_short_long_validation_results.json`
- report_md: `data/backtest_results/multi_agent_validation/phase3/battery_2025_w44_short_hybrid05_top10_realistic_costs/ai_short_long_validation_report.md`
