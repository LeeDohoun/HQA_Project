...
"""Create a cleaner period evidence snapshot for backtest retrieval.
...
from backtesting.temporal_evidence import save_jsonl
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"[CLEAN evidence] input: {input_dir}")
    print(f"[CLEAN evidence] output: {output_dir}")
    print(f"[CLEAN evidence] rows: {report['input_count']} -> {report['output_count']} (-{report['dropped_count']})")
    print(f"[CLEAN evidence] sources: {report['output_source_counts']}")
    print(f"[CLEAN evidence] drop_reasons: {report['drop_reasons']}")
